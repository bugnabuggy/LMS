    ...
    public partial class Update01 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GoalState", x => x.Id);
                });
            migrationBuilder.CreateTable(
                name: "User",
                columns: table => new
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Goal_UserArea_AreaId",
                        column: x => x.AreaId,
                        principalTable: "UserArea",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Goal_GoalState_StateId",
                        column: x => x.StateId,
                        principalTable: "GoalState",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            migrationBuilder.CreateTable(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CalendarTask_Goal_GoalId",
                        column: x => x.GoalId,
                        principalTable: "Goal",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
        ...
        {
            migrationBuilder.DropTable("CalendarTask");
            ...
            migrationBuilder.DropTable("UserArea");
            migrationBuilder.DropTable("GoalState");
